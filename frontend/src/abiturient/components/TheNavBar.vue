...
<div id="app">
    <b-navbar toggleable="md" type="dark" variant="primary">
        ...
        <b-navbar-brand :ato="{ name: 'catalog' }">Личный кабинет</b-navbar-brand>

        <b-collapse is-nav id="nav_collapse">

            <b-navbar-nav>
                <b-nav-item :to="{ name: 'catalog' }">Каталог проектов</b-nav-item>
                <b-nav-item :to="{ name: 'sessions' }">Мои проекты</b-nav-item>
                <!-- <b-nav-item :to="{ name: 'results' }">Наградные материалы</b-nav-item> -->
                <b-nav-item :to="{ name: 'teams' }">Группы и участники</b-nav-item>
                <!-- <b-nav-item :to="{ name: 'tools' }">Инструменты</b-nav-item> -->
            </b-navbar-nav>
            ...
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown right v-if="profile.id">
